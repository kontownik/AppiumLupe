...
public class BaseTest {
    ...
    public void beforeMethod(ITestContext iTestContext) throws MalformedURLException {
        ...
        capabilities.setCapability(MobileCapabilityType.PLATFORM_VERSION, "6.0.1"); // adb -s " + deviceID + " shell getprop ro.build.version.release //6.0.1 //4.4.4.
        capabilities.setCapability(MobileCapabilityType.DEVICE_NAME, "Android"); //wartosc ponoc nie uzywana ale wymagana
        capabilities.setCapability(MobileCapabilityType.UDID, "YT910NB72F"); //ID zalezne od urzadzenia, pobiera sie z "adb devices" pi: ZH80084532  moj:"YT910NB72F"
        capabilities.setCapability("intentAction", "android.intent.action.MAIN"); // bez tego akcja bedzie nullem co moze powodowac problemy
